...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>si', builtin.git_status, { desc = '[S]earch modified G[i]t Files' })
      vim.keymap.set('n', '<leader>se', builtin.command_history, { desc = '[S]earch R[e]cent Commands' })
